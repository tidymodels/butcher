...
- [`axe-formula`](https://butcher.tidymodels.org/reference/axe-formula.md):
  `formula`

- [`axe-function`](https://butcher.tidymodels.org/reference/axe-function.md):
  `function`
...
- [`axe-kknn`](https://butcher.tidymodels.org/reference/axe-kknn.md):
  `kknn`

- [`axe-lm`](https://butcher.tidymodels.org/reference/axe-lm.md): `lm`

- [`axe-mass`](https://butcher.tidymodels.org/reference/axe-mass.md):
  `lda`, `polr`, `qda`
...
- [`axe-recipe`](https://butcher.tidymodels.org/reference/axe-recipe.md):
...
- [`axe-terms`](https://butcher.tidymodels.org/reference/axe-terms.md):
  `terms`
