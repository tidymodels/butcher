...
[`weigh()`](https://butcher.tidymodels.org/reference/weigh.md) function:
...
- [`axe_env()`](https://butcher.tidymodels.org/reference/axe_env.md): To
  remove environments.
- [`axe_fitted()`](https://butcher.tidymodels.org/reference/axe_fitted.md):
  To remove fitted values.

When you run
[`butcher()`](https://butcher.tidymodels.org/reference/butcher.md), you
execute all of these axing functions at once. Any kind of axing on the
object will append a butchered class to the current model object
...
Check out the
[`vignette("available-axe-methods")`](https://butcher.tidymodels.org/articles/available-axe-methods.md)
...
[`vignette("adding-models-to-butcher")`](https://butcher.tidymodels.org/articles/adding-models-to-butcher.md)
