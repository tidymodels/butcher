...
- [`axe_call`](https://butcher.tidymodels.org/reference/axe_call.md) To
  remove the call object.

- [`axe_ctrl`](https://butcher.tidymodels.org/reference/axe_ctrl.md) To
  remove controls associated with training.

- [`axe_data`](https://butcher.tidymodels.org/reference/axe_data.md) To
