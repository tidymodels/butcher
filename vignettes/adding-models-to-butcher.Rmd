...
If you come across any model objects that should be subject to butchering, but does not exist in our current repository as listed [here](https://www.tidymodels.org/find/parsnip/), please consider becoming a contributer to this package! For any first-timers, this is great place to start as we've created templates that make this process as seamless as possible. 
